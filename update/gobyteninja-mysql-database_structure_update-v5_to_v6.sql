...
-- Execute this MySQL script to update your Database from v5 to v6
...
ALTER TABLE `cmd_info_blocks`
  ADD `BlockDarkSendTXCount` INT NOT NULL DEFAULT '0'
  AFTER `SuperBlockBudgetName`,
  ADD `MemPoolDarkSendTXCount` INT NOT NULL DEFAULT '0'
  AFTER `BlockDarkSendTXCount`;

--
-- Update actual version number
--

UPDATE `cmd_config` SET `DataBaseVersion`=6 WHERE `DataBaseVersion`=5
